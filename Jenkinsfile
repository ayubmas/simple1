    ...
    stages {
		...
		steps {
			script {
				...
				sh 'curl -X POST -u amassalha:1182626fa7f66f2e71672923dc955dce45 'http://jenkins.beyondminds.ai:8080/job/Ayub/job/BUILD/buildWithParameters?token=1234&BUILD_TYPE=simple1''
